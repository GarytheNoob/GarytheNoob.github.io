    ...
    var injectHTML5Applet = function (appletElem, parameters, noPreview) {
      ...
      if (loadScript) {
        ...
        if (
          ...
          //require(["ggb_ext/5.0/web3d/web3d.nocache"], scriptLoaded);
        } else {
    ...
    function webModule() {
      ...
      function C() {
        ...
        function j() {
          var a = p.location;
          return (
            a.href == a.protocol + Cb + a.host + a.pathname + a.search + a.hash
          );
        }
        var k = g();
        if (k == W) {
      ...
      webModule.__moduleBase =
        "https://www.geogebra.org/apps/5.0.760.0/" + name + "/";
